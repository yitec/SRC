...
if($total>0){
	...
	$query="insert into tbl_usuarios(ids_perfil,ids_reportes,id_empresa,nombre,apellidos,cedula,usuario,clave,vence,estado)values('".$_REQUEST['id_permisos']."','".$_REQUEST['ids_reportes']."','".$_SESSION['empresa']."','".$_REQUEST['txt_nombre']."','".$_REQUEST['txt_apellidos']."','".$_REQUEST['txt_cedula']."','".$_REQUEST['txt_usuario']."','".$_REQUEST['txt_pass']."','".$fecha2."','"."1"."')";
...
if($_REQUEST['opcion']==2)
{
	...
	echo $row['usuario']."|".$row['nombre']."|".$row['apellidos']."|".$row['cedula']."|".$row['clave']."|".$row['vence']."|".$row['ids_perfil']."|".$row['ids_reportes'] ;   
...
{		
	$result=mysql_query("update tbl_usuarios set usuario='".$_REQUEST['txt_usuario']."',nombre='".$_REQUEST['txt_nombre']."',apellidos='".$_REQUEST['txt_apellidos']."',cedula='".$_REQUEST['txt_cedula']."',clave='".$_REQUEST['txt_pass']."',vence='".$fecha2."',ids_perfil='".$_REQUEST['id_permisos']."' , ids_reportes='".$_REQUEST['ids_reportes']."'  where usuario='".$_REQUEST['txt_usuario_buscar']."'");
