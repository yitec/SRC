...
<img src="img/PASO2.jpg" />
 ...
 Programe su campa&ntilde;a</div>
  ...
  <table>
    ...
    <tr>
    <td><div class="Arial14Morado">Mensaje Parte 1</div></td><td><textarea class=" textArea " name="txt_mensaje1" cols="30" rows="3" maxlength="157"></textarea>
    </td>
    </tr>
    <td><div class="Arial14Morado">Mensaje Parte 2</div></td><td><textarea class=" textArea " name="txt_mensaje2" cols="30" rows="3" maxlength="157"></textarea>
    </td>
    </tr>
    </table>
    <table>
