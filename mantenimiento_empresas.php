...
<script src="includes/Scripts_Empresas.js" type="text/javascript"></script> 
...
<div id="mainBlancoFondo" style=" width:750px;" align="center">
	<div class="Arial14Negro" style="margin-left:470px; float:left; margin-top:5px;   ">Cliente:</div>
     <div class="ui-widget" style="float:left;"><input class="inputboxPequeno" size="20" id="txt_empresa_buscar" name="txt_orden" type="text"  /></div>
    <input name="btn_buscar" id="btn_buscar" type="image" src="img/search.png" />

	<div align="center" class="Arial18Azul" style="margin-bottom:10px; margin-top:10px;">Informaci&oacute;n General Empresas</div>
	<table>
	  <tr>
	    <td height="20" class="Arial14Negro">Nombre</td>
